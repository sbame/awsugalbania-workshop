...
instructions = '''<p><em>Hint</em>: This is a RESTful web service! Append a username to the URL (for example: <code>/AWS-UserGroup-ALBANIA!</code>) to say hello to someone specific.</p>\n'''
